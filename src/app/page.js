...
import homeRecordOne from '@/public/assets/images/png/home-records-one.png';
    ...
    <div className="flex min-h-screen w-full flex-col bg-white">
      ...
      <main className="flex w-full relative z-1 max-w-7xl mx-auto flex-col items-center bg-white">
        ...
        <VerticalBorderPattern gradientName="backgroundGradient">
          <section className="flex w-full overflow-hidden mx-auto flex-row items-center min-h-screen text-center pt-50 ">
            <div className="flex w-full  max-w-300 mx-auto flex-row flex-1 h-full items-start justify-between px-10 gap-8">
              <div className="flex flex-col h-full items-start lg:w-full justify-center gap-8 ">
                ...
                <div className="flex flex-row gap-4">
                  <Button padding="px-8">Start Free trail</Button>
                  <Button gradientColor="bg-white hover:text-white px-8">
                    Watch demo
                  </Button>
                </div>
              </div>
                      ...
                      <div className="flex flex-col gap-6" key={index}>
                        ...
                        <div className="flex flex-col gap-3">
                          {item?.featureHighlight?.map((hightLightItem) => (
                            <div className="font-body flex flex-row gap-3 items-start text-stone700 text-start text-[14px]">
                              <span>
                                <CircleThickIcon />{' '}
                              </span>{' '}
        ...
        {/* Zigzig content */}
        <VerticalBorderPattern>
          <ZigZagHomeSection mapData={homeZipZapContent} />
        </VerticalBorderPattern>

        {/* Grid Cards content */}
        <VerticalBorderPattern gradientName="backgroundGradientAnimation">
          <CenterTextCardsSection mapData={powerfulCardSectionData} />
        </VerticalBorderPattern>
