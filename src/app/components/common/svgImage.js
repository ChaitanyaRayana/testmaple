...
export const HumanResourcesCardIcon = ({
  width = 24,
  height = 24,
  color = 'text-stone-500',
}) => {
...
export const ResearchDeploymentIcon = ({
  width = 16,
  height = 16,
  color = 'text-stone-500',
}) => {
...
export const BrainIcon = ({ width = 24, height = 24 }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={width}
...
export const LightingIcon = ({ width = 24, height = 24 }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={width}
